...
```mermaid
flowchart TD
    CONTENT["Blog and honest content"] --> FAK["First Action Kit - free"]
    FAK --> COURSE["7-day starter email course"]
    COURSE --> MINI["Mini purchase - 9 to 19 USD"]
    MINI --> CORE["Core system - 34 to 49 USD"]
    CORE --> FLAG["Anchor Life OS 79 USD or Everything Bundle 99 to 129 USD"]
    FLAG --> LAB["Anchor Lab - 8 USD per month or 79 USD per year"]
    LAB --> PANEL["Voluntary outcomes panel"]
    PANEL --> BETTER["Measured function: better products, honest claims"]
    BETTER --> CONTENT
    MINI -. some buyers skip ahead .-> FLAG
    LAB -. consented themes and stories .-> CONTENT
